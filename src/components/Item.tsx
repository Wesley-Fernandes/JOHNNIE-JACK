...
export default function Item(props:FoodFullInterface) {
  return (
    <Link href={`/foods/${props.id}`} className="col-span-1 flex min-h-fit p-2 rounded-md border shadow-sm cursor-pointer hover:border-red-500">
        ...
        <div className="flex flex-col justify-between pl-2  flex-1">
            ...
            <div className="flex min-h-12 p-0.5 overflow-y-auto">
                <p className='text-xs opacity-65 w-full font-light rounded-lg'>{props.description}</p>
            </div>
